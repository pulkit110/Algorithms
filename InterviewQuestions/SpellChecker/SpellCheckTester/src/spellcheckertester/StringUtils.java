...
public class StringUtils {
	...
	public static List<String> changeVowelsAt(String s, int pos) {
		...
		if (vowels.contains(s.charAt(pos))) {
	...
	public static String addCharAt(String s, int pos, char c) {
	   StringBuffer buf = new StringBuffer(s);
	   buf.insert(pos, c);
	   return buf.toString();
	}
	...
	public static String RepeatLettersAt(String s, int pos) {
		return addCharAt(s, pos, s.charAt(pos));
	}
